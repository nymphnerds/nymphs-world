...
import codexRoutes, { codexPublicRoutes } from './routes/codex.js';
...
// Public Codex browser handoff route. The login session id is generated by the
// Codex app-server and lets the external browser follow a short local URL.
